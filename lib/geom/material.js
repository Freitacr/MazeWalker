...
var Material = function() {
    ...
    this.diffuse = vec3.fromValues(0.3, 0.7, 0.7);
...
Material.prototype.setUniforms = function(gl, uni) {
    ...
    gl.uniform3fv(uni.uEmissive, Float32Array.from(this.emissive));
    gl.uniform3fv(uni.uAmbient, Float32Array.from(this.ambient));
    gl.uniform3fv(uni.uDiffuse, Float32Array.from(this.diffuse));
    gl.uniform3fv(uni.uSpecular, Float32Array.from(this.specular));
