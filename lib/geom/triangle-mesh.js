 ...
 */
TriangleMesh.prototype.render = function(gl, uni, material = this.material) {
    // If the buffers haven't been initialized, do nothing
    if( ! this.vao ) return;

    // Set uniforms from the material
    ...
    // As shading exists, there is no need for any edge drawing
};